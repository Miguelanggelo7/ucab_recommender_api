...
def content_filtering_process(current_user, user_skills, user_specializations):
    ...
    for course in courses:
        like = UserLikes.query.filter_by(
    ...
    for course in courses_data:
        ...
        course_title_clean = unidecode(course_title).lower().translate(
            str.maketrans("", "", string.punctuation))
        course_career_clean = unidecode(course_career).lower().translate(
            str.maketrans("", "", string.punctuation))
        course_description_clean = unidecode(course_description).lower(
        ).translate(str.maketrans("", "", string.punctuation))
        course_requirements_clean = unidecode(course_requirements).lower(
        ).translate(str.maketrans("", "", string.punctuation))
